...
module.exports = function(Viewsifecatalogosh) {
    ...
    disableMethods(Viewsifecatalogosh,methodName)
    });
};
// Funcion que realiza un bucle para bloquear los metodos nativos de loopback
function disableMethods(Viewsifecatalogosh,methodName)
{
    if(methodName!='updateAttributes')
    Viewsifecatalogosh.disableRemoteMethodByName(methodName, true);
    else
    Viewsifecatalogosh.disableRemoteMethodByName(methodName, false); 
}
