...
module.exports = function(Viewsifegrupoproductos) {
    ...
    disableMethods(Viewsifegrupoproductos,methodName)
    });
};
// Funcion que realiza un bucle para bloquear los metodos nativos de loopback
function disableMethods(Viewsifegrupoproductos,methodName)
{
if(methodName!='updateAttributes')
Viewsifegrupoproductos.disableRemoteMethodByName(methodName, true);
else
Viewsifegrupoproductos.disableRemoteMethodByName(methodName, false); 
}